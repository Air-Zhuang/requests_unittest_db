...
datas={
    ...
    'sign_event':[
        {'id':1,'name':'红米Pro发布会','`limit`':2000,'status':1,'address':'北京会展中心',
         'start_time':'2019-08-20 00:25:42','create_time':'2018-02-9 00:25:42'},
        ...
        {'id':4,'name':'发布会已结束','`limit`':2000,'status':1,'address':'北京会展中心',
         'start_time':'2001-08-20 00:25:42','create_time':'2018-02-9 00:25:42'},
    ...
    'sign_guest':[
        {'id':1,'realname':'alen','phone':13511001100,'email':'alen@mail.com',
         'sign':0,'event_id':1,'create_time':'2018-02-9 00:25:42'},
        {'id':2,'realname':'has sign','phone':13511001101,'email':'sign@mail.com',
         'sign':1,'event_id':1,'create_time':'2018-02-9 00:25:42'},
        {'id':3,'realname':'tom','phone':13511001102,'email':'tom@mail.com',
         'sign':0,'event_id':5,'create_time':'2018-02-9 00:25:42'},
    ],
}
#将测试数据插入表
def init_data():
